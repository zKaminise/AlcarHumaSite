        ...
        <div className="max-w-6xl mx-auto">
                  ...
                  <Card key={index} className="card-floating card-glow bg-card-dark backdrop-blur-sm border-border/30 hover:border-primary/40 transition-all duration-300">
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        <div className="bg-gradient-to-br from-primary to-secondary text-white rounded-2xl w-8 h-8 flex items-center justify-center font-bold text-sm flex-shrink-0 mt-1 shadow-lg">
                          {item.step}
                        </div>
                        <div>
          ...
          <ScrollAnimation delay={600}>
            <div className="text-center">
              <Button 
                className="bg-primary hover:bg-primary/90 text-primary-foreground px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 text-sm sm:text-base md:text-lg"
                onClick={() => {

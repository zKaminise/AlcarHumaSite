          ...
          <ScrollAnimation animationType="fade-in-up">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-4 leading-relaxed">
                Nossa equipe de especialistas está pronta para impulsionar o crescimento da sua empresa.
              </p>
            </div>
          </ScrollAnimation>
        </div>
            ...
            <ScrollAnimation animationType="slide-in-right">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Nossa equipe de especialistas está pronta para entender suas necessidades e propor soluções sob medida
                  para o seu negócio.
                </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <ScrollAnimation delay={100} animationType="fade-in-up">
              <div className="group relative bg-gradient-to-br from-green-500/10 to-green-600/5 p-8 rounded-2xl border border-green-500/20 hover:border-green-500/40 transition-all duration-500 hover:shadow-xl hover:shadow-green-500/10 hover:-translate-y-1 h-full flex flex-col">
                ...
                <div className="relative flex flex-col flex-1">
                  ...
                  <p className="text-muted-foreground text-sm mb-4 flex-1">(11) 99999-9999</p>
            ...
            <ScrollAnimation delay={200} animationType="fade-in-up">
              <div className="group relative bg-gradient-to-br from-blue-500/10 to-blue-600/5 p-8 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-500 hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-1 h-full flex flex-col">
                ...
                <div className="relative flex flex-col flex-1">
                  ...
                  <p className="text-xs text-muted-foreground/70 mb-4 flex-1">Resposta em até 24h</p>
            ...
            <ScrollAnimation delay={300} animationType="fade-in-up">
              <div className="group relative bg-gradient-to-br from-orange-500/10 to-orange-600/5 p-8 rounded-2xl border border-orange-500/20 hover:border-orange-500/40 transition-all duration-500 hover:shadow-xl hover:shadow-orange-500/10 hover:-translate-y-1 h-full flex flex-col">
                ...
                <div className="relative flex flex-col flex-1">
                  ...
                  <p className="text-xs text-muted-foreground/70 flex-1">Presencial ou on-line</p>
                </div>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation delay={400} animationType="fade-in-up">
              <div className="group relative bg-gradient-to-br from-purple-500/10 to-purple-600/5 p-8 rounded-2xl border border-purple-500/20 hover:border-purple-500/40 transition-all duration-500 hover:shadow-xl hover:shadow-purple-500/10 hover:-translate-y-1 h-full flex flex-col">
                ...
                <div className="relative flex flex-col flex-1">
                  ...
                  <p className="text-xs text-muted-foreground/70 flex-1">Atendimento em todo território nacional</p>
                </div>
              </div>
            </ScrollAnimation>
          </div>
          ...
          <ScrollAnimation>
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground">Baseados em São Paulo, atendemos clientes em todo o Brasil</p>
              </div>

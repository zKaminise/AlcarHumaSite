const WhatsAppFloat = () => {
  const phoneNumber = "5567996442404";
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="relative bg-[#25D366] rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
          <svg
            width="28"
            height="28"
            viewBox="0 0 24 24"
